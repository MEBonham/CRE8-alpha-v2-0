export const defaultActions = {
    ...
    special_attacks: [
        ...
        "Disarm:",
        "Grab: provoke opportunity attacks from a target within the threatened area of your unarmed strike. That target must then make a Defense Save against TN 10 + your Fighting Level. On a failure, the target becomes Grabbed until some effect or action ends the grapple.",
        "Shove: provoke opportunity attacks from a target within the threatened area of your unarmed strike. That target must then make an Athletics or Brawn check (whichever is better) to keep its footing. The TN is 10 + your Fighting Level. If the check fails, you may inflict the Prone condition on the target or shove it up to 5 ft away from you. If you are bigger than the target, this increases by 5 ft for each size category of difference.",
